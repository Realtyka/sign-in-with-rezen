...
// This is a public client: there is no client secret field, here or
...
export function loadConfig() {
  ...
  const redirectUri = env.REDIRECT_URI || 'http://[::1]:4501/callback';
  ...
  return { issuer, clientId, redirectUri, scopes, port, apiBase };
}
